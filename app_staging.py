...
# app_staging.py - STAGING Modal deploy entrypoint (v0.9.10 hotfix).
#
# 純抄 v2.0.6 base app.py · 只改 app name = castle-voice-engine-staging
# 不引入 dev_endpoints / 不改 brain_endpoints / tavus_endpoints (base 既有)
# Deploy: modal deploy app_staging.py
#
# 原 app.py header 接續 ↓
#
...
# v0.9.10 hotfix · staging entrypoint · 純抄 app.py · 只改 app name
# Edward APPROVE staging → prod deploy 不動 prod
