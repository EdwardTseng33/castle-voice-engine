# breeze_poc/run_chatterbox_longform.py
# Voice Path v2.0 Phase 1 PoC - Chatterbox-Turbo LONGFORM stability test
# 2026-05-22 calcifer - L01 (350 chars work report) / L02 (230 chars emotional) / L03 (200 chars cn-en mixed)
# Test: voice consistency / volume stability / pause naturalness / cn-en code-switching
...
meta = {
    "test_name": "Chatterbox-Turbo Longform Stability Test",
    "purpose": "Verify voice consistency / volume stability / pause naturalness / cn-en code-switching on 200-350 char passages",
    ...
    "voice_ref_source": "Azure Edge TTS zh-TW-HsiaoYuNeural (Xiao Yu, same as previous short-test)",
    ...
    "ship_session": "calcifer 5/22 Chatterbox-Turbo longform stability test (Edward spec)",
    "test_scenarios": [
...
for test in TESTS:
    ...
    try:
        ...
        print("  OK lat=" + str(result["latency_ms"]) + "ms inf=" + str(result["inference_ms"]) + "ms dur=" + str(actual_dur) + "s" + warn)
